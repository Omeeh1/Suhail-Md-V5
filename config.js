...
global.email ="Itzlordfruzzy@gmail.com"
...
global.devs = "242068308379" // Developer Contact
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "<dËmiGTy>ÆÏM",
  packname: process.env.PACK_NAME || "ᕗяєvᕗ",
  botname : process.env.BOT_NAME  || "sᴜʜᴀɪʟ-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "<dËmiGTy>ÆÏM",


  errorChat : process.env.ERROR_CHAT || "fuck🤦🏾‍♂️!it's an error,
